...
const CyberButton = ({ children, onClick, type = "button", variant = "violet", className = "" }) => {
  const themes = {
    ...
    violet: "bg-[#0095F6] hover:bg-[#1877F2] border-transparent text-white font-semibold shadow-sm",
    // Nexora Brand Gradient premium button
    pink: "bg-gradient-to-r from-[#FCAF45] via-[#E1306C] to-[#C13584] hover:opacity-95 border-transparent text-white font-semibold",
